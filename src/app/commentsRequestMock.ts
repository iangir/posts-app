import type { PostComment } from 'entities/comment/model/types/comment';
...
const fetchCommentsMock = (postId: PostComment['postId']): Promise<PostComment[]> => {
	return new Promise((resolve) => {
		setTimeout(() => {
			resolve(comments.filter((comment) => comment.postId === postId));
		}, 1000);
	});
};

export default fetchCommentsMock;
